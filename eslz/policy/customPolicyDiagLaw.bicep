  ...
  }
  {
    ...
    setChildDefinitions: [
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy-defset-Deploy-Diagnostics-LogAnalytics-Sentinel.parameters.json')).SqlServerAuditing.parameters
      }
    ]
  }
]
