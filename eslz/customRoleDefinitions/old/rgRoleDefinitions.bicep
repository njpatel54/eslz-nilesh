...
// Required to create Role Definition at resourceGroup level for Role called "Deploy Private Endpoint - Networking Permissions"
@description('Required. Resource Group name.')
param resourceGroupName string = 'rg-${projowner}-${opscope}-${region}-vnet'

// Required to create Role Definition at resourceGroup level for Role called "Deploy Private Endpoint - Private DNS A Contributor"
@description('Required. Resource Group name.')
