...
param parTargetManagementGroupId string = 'mg-A2g'
...
var customPolicySetDefinitions = [
  {
    ...
    setChildDefinitions: [
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deny_publicpaasendpoints.parameters.json')).MySQLFlexDenyPublicIP.parameters
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deny_publicpaasendpoints.parameters.json')).PostgreSQLFlexDenyPublicIP.parameters
      }
      {
  ...
  }
  {
    ...
    setChildDefinitions: [
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deploy_mdfc_config.parameters.json')).defenderForAppServices.parameters
      }
      {
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deploy_mdfc_config.parameters.json')).defenderForKeyVaults.parameters
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deploy_mdfc_config.parameters.json')).defenderForOssDb.parameters
      }
      {
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deploy_mdfc_config.parameters.json')).defenderForSqlServerVirtualMachines.parameters
      }
      {
  ...
  }
  {
    ...
    setChildDefinitions: [
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_deploy_private_dns_zones.parameters.json'))['DINE-Private-DNS-Azure-Web'].parameters
      }
    ]
  }
  {
  ...
  }
  {
    ...
    setChildDefinitions: [
      ...
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_enforce_encryption_cmk.parameters.json')).HealthcareAPIsCMKEffect.parameters
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_enforce_encryption_cmk.parameters.json')).MySQLCMKEffect.parameters
      }
      {
        ...
        definitionParameters: json(loadTextContent('policySetDefinitions/policy_set_definition_es_enforce_encryption_cmk.parameters.json')).PostgreSQLCMKEffect.parameters
      }
      {
...
resource policyDefinitions 'Microsoft.Authorization/policyDefinitions@2020-09-01' = [for policy in customPolicyDefinitions: {
...
resource policySetDefinitions 'Microsoft.Authorization/policySetDefinitions@2020-09-01' = [for policySet in customPolicySetDefinitions: {
  dependsOn: [
    policyDefinitions
  ]
  ...
  properties: {
    ...
    policyType: policySet.setDefinition.properties.policyType
