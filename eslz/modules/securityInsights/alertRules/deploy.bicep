...
param existingWorkspaceName string = '<Enter Log Analytics Workspace name>'

@description('Name for this scheduled alert rule. Must be unique for the workspace')
param ruleName string

var ruleGuid_var = uniqueString(ruleName)

resource ruleGuid 'Microsoft.SecurityInsights/alertRules@2021-03-01-preview' = {
  scope: 'Microsoft.OperationalInsights/workspaces/${existingWorkspaceName}'
  name: ruleGuid_var
  kind: 'Scheduled'
  properties: {
